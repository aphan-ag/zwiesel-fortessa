...
<form class="login-register-login-form" novalidate>
	<fieldset class="login-register-login-form-fieldset">
		...
		<!-- GOOGLE RECAPTCHA V2 -->
		<div class="g-recaptcha" id="g-recaptcha-1" data-sitekey="{{siteKey}}"></div>
		<div id="g-recaptcha-login-message-1"></div>
        ...
        {{#if showForgotPasswordMessage}}
            <div class="info-card login-register-login-description">
