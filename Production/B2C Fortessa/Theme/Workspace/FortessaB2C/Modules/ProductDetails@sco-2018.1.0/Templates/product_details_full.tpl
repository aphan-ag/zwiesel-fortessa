...
<div class="product-details-full">
    ...
    <script>
        ...
        fbq('init', '186352563261151');
        fbq('track', 'PageView');
        fbq('track', 'ViewContent');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=186352563261151&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
	...
	<article class="product-details-full-content">
			...
			<div class="product-details-full-main-content-right">
                <div class="product-details-full-main">
                    <div class="product-details-full-content-header">
                        ...
                        <div data-view="Bazaarvoice.PDP.RatingSummary"></div>
        ...
        <section class="product-details-full-bottom-content">
            ...
            <div data-view="Bazaarvoice.PDP.Reviews"></div>
            <div data-view="Bazaarvoice.PDP.Questions"></div>
