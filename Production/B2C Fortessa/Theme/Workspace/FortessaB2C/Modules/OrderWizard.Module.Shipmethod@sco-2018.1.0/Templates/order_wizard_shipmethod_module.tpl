<div class="order-wizard-paymentmethod-giftcertificates-module-expander-head stepHidden">
		<a class="order-wizard-paymentmethod-giftcertificates-module-expander-head-toggle collapsed" data-toggle="collapse" data-target="#progressive-delivery-method" aria-expanded="false" aria-controls="progressive-delivery-method" data-action="progressive-header">
			{{translate 'Delivery Method'}}
			<i class="order-wizard-paymentmethod-giftcertificates-module-expander-icon"></i>
		</a>
</div>

<div class="order-wizard-shipmethod-module progressive-containerHidden collapse" id="progressive-delivery-method" data-action="progressive-delivery-method">
	{{#if showTitle}}
	...
	<div data-view="Progressive.Button" class="progressive-forms"></div>
</div>
