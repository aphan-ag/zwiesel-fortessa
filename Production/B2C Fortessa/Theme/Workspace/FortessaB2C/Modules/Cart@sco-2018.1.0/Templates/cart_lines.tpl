...
<div id="{{lineId}}" data-item-id="{{itemId}}" data-type="order-item"
	class="{{#if showGeneralClass}} {{generalClass}} {{/if}} cart-lines-row">
	...
	<div class="cart-lines-table-details">
		...
		<div class="cart-lines-table-item-spec">
			<div class="cart-lines-table-middle">
				...
				{{/if}}
				{{#if uomData}}
					<div class="uom-product-views-option-tile-label-checkout">
