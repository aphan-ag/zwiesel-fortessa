<div class="order-wizard-paymentmethod-giftcertificates-module">
	...
	<div class="order-wizard-paymentmethod-giftcertificates-module-expander-head">
		<a class="order-wizard-paymentmethod-giftcertificates-module-expander-head-toggle stepHidden" data-toggle="collapse" data-target="#gift-certificate-form" aria-expanded="false" aria-controls="gift-certificate-form" data-action="progressive-header">
	...
	<form id="gift-certificate-form" class="order-wizard-paymentmethod-giftcertificates-module-form progressive-containerHidden collapse" data-action="gift-certificate-form">
