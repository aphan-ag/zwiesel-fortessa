<div class="order-wizard-paymentmethod-giftcertificates-module-expander-head">
		<a class="order-wizard-paymentmethod-giftcertificates-module-expander-head-toggle collapsed" data-toggle="collapse" data-target="#progressive-payment-method" aria-expanded="false" aria-controls="progressive-payment-method">
			{{translate 'Payment'}}
...
<div class="order-wizard-paymentmethod-selector-module progressive-container collapse" id="progressive-payment-method" data-action="progressive-payment-method">
	{{#if showTitle}}
