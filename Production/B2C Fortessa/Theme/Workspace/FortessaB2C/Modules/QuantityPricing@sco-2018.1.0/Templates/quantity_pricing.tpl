		...
		<div class="quantity-pricing-container">
			{{#if isAccordion}}
				<div class="quantity-pricing-expander-head">
				 	<a class="quantity-pricing-expander-head-toggle {{#unless isOpen}}collapsed{{/unless}}" data-toggle="collapse" data-target="#expander-body-container-{{itemKey}}" aria-expanded="true" aria-controls="expander-body" data-action="toggle" href="#">
			...
			{{/if}}
				...
				<div class="quantity-pricing-expander-body-container">
					<table>
						<thead>
							<tr>
								<td class="quantity-pricing-table-header-quantity">{{translate 'Quantity'}}</td>
								<td class="quantity-pricing-table-header-price">{{translate 'Price'}}</td>
							</tr>
						</thead>
						<tbody>
							{{#each priceSchedule}}
