<div class="order-wizard-paymentmethod-giftcertificates-module-expander-head card">
	<a id="heading-{{manageValue}}" class="order-wizard-paymentmethod-giftcertificates-module-expander-head-toggle collapsed" data-toggle="collapse" data-target="#progressive-address-{{manageValue}}" aria-expanded="false" aria-controls="progressive-address-{{manageValue}}" data-action="progressive-header">
		{{title}}
		<i class="order-wizard-paymentmethod-giftcertificates-module-expander-icon"></i>
	</a>
</div>

<div class="order-wizard-address-module progressive-container collapse" id="progressive-address-{{manageValue}}" data-action="progressive-address-{{manageValue}}" data-parent="#wizard-step-content" aria-labelledby="heading-{{manageValue}}">
	<div class="order-wizard-address-module-show-addresses-container">
		...
		{{/if}}
		<div data-view="Progressive.Button" class="progressive-forms-{{manageValue}}"></div>
	</div>
</div>
