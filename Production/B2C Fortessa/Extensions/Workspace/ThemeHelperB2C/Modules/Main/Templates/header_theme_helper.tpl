...
<div class="header-main-wrapper">
    {{#if extraHeaderView.bannertext}}
        <div class="header-banner-text-container">
			{{headerBannerTitle}}
			<nav>
				{{#each headerBannerNavItems}}
					<a href="{{link}}" class="{{#if active}}active{{/if}}">{{title}}</a>
				{{/each}}
			</nav>
		</div>
    {{/if}}
	<nav class="header-main-nav">
		...
		<div class="header-sidebar-toggle-wrapper">
			<button class="header-sidebar-toggle" data-action="header-sidebar-show" aria-label="Menu Sidebar">
				<i class="header-sidebar-toggle-icon"></i>
				<span class="invisible">Menu SideBar</span>
			</button>
		</div>
		...
		<div class="header-content container">
			...
			<div class="header-right-menu">
				...
				<ul class="header-subheader-options"></ul>
